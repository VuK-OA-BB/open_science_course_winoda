...
![Two institutional figures shaking hands, representing the connection between the two guiding pathways](./images/Kooperation.png)<!-- style="display: block; width: 40%; max-width: 220px; margin: 6rem auto 0 auto;" -->
...
![Illustration of a person reflecting on their prior knowledge before starting the course](./images/Autor_w.png)<!-- style="display: block; width: 25%; max-width: 220px; margin: 2rem auto 0 auto;" -->
...
![Smiling trophy representing learning success](./images/Erfolg.png)<!-- style="display: block; width: 30%; max-width: 220px; margin: 6rem auto 0 auto;" -->
...
![Illustration of a pencil writing on a document, representing the development of an Open Science action plan](./images/Schreiben2.png)<!-- style="display: block; width: 30%; max-width: 220px; margin: 5rem auto 0 auto;" -->

---

## Module 1: Open Science basics

![Illustration of a padlock surrounded by a globe, symbolising global access, security, and responsible openness in research](./images/OA_transformation_2.png)<!-- style="display: block; width: 30%; max-width: 220px; margin: 7rem auto 0 auto;" -->
...
![A smiling trophy representing the successful achievement of the module learning objectives](./images/Erfolg.png)<!-- style="display: block; width: 30%; max-width: 220px; margin: 5rem auto 0 auto;" -->
...
![Illustration of a smiling light bulb emerging from an open treasure chest, representing the discovery and sharing of knowledge](./images/Treasure_trove_of_knowledge_1.png)<!-- style="display: block; width: 40%; max-width: 220px; margin: 5rem auto 0 auto;" -->
...
![Illustration of interlocking gears representing Open Science as a connected set of movements and research practices](./images/Prozess.png)<!--style="display: block; width: 40%; max-width: 220px; margin: 1rem auto 0 auto;" -->
...
![WiNoDa Knowledge Lab logo with a green spiral and pixel motif next to the blue WiNoDa wordmark and the subtitle Knowledge Lab](./images/WINODA_logo.png)<!-- style="display: block; width: 60%; max-width: 1200px; height: auto; margin: 7rem auto 0 auto;" -->
...
![Two puzzle pieces positioned to connect, symbolising interoperability between infrastructures](./images/Interoperability_2.png)<!-- style="display: block; width: 40%; max-width: 450px; height: auto; margin: 3rem auto 0 auto;" -->
...
![Illustration of a hand using a magnifying glass to examine one of several geometric objects, symbolising analysis and self-assessment](./images/Analysieren1.png)<!-- style="display: block; width: 35%; max-width: 450px; height: auto; margin: 3rem auto 0 auto;" -->
...
![Circular arrows representing the research workflow, with arrows pointing outward to symbolise openness and the sharing of research outputs](./images/Workflow.png)<!-- style="display: block; width: 40%; max-width: 450px; height: auto; margin: 3rem auto 3rem auto;" -->
